                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            const Text("My Cart", textAlign: TextAlign.center, style: TextStyle(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      ...
                                      child: address == null || address == "" ? Text("") : Text(address.toString().toUpperCase(), style: TextStyle(color: Colors.black, fontSize: 12)))
                                ],
                              ),
                            ),
                          ),
                                  ...
                                  return ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        return itemContainer(
                                            ...
                                            snapshot.data[index]['cart_id'].toString(),
                                            snapshot.data[index]['product_name'].toString(),
                                            snapshot.data[index]['product_image'].toString(),
                                            snapshot.data[index]['quantity'].toString(),
                                            snapshot.data[index]['amount'].toString(),
                                            snapshot.data[index]['offer_price'].toString(),
                                            snapshot.data[index]['short_description'].toString(),
                                            (parse(parse(snapshot.data[index]['group_price'].toString()).body.text).documentElement.text).toString()
                                        );
                                      });
                                } else {
                                  return Center(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                  totalitems.toString() == "1" ? Text(totalitems.toString()+" Item", style: const TextStyle(
                                  fontSize: 16,
                                  color: Colors.white,
                                )) : Text(totalitems.toString()+" Items", style: const TextStyle(
                                    fontSize: 16,
                                ...
                                SizedBox(width: 10),
                                Expanded(
                                  child: Text(totalprice.toString() != null
                                        ? "\u20B9 $totalprice"
                                        : 0.toString(),
                                    style: const TextStyle(
                                        color: Colors.white,
                                ...
                                const Text("Proceed to pay", style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w500)),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            const Text("My Cart", textAlign: TextAlign.center, style: TextStyle(fontStyle: FontStyle.normal, fontSize: 21, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ],
                    ),
        ...
        child: Slidable(
          ...
          secondaryActions: <Widget>[
            Container(
              ...
              color: Colors.red,
              alignment: Alignment.center,
              child: IconButton(onPressed: (){showAlertDialog(context, cardid.toString());}, icon: Icon(Icons.delete_outline, color: Colors.white, size: 32)),
            ),
          ],
        ),
      ),
    ...
    if (response.statusCode == 200) {
      if (json.decode(response.body)['ErrorCode'].toString() != "0") {
        ...
        setState(() {
          ...
          address = json.decode(response.body)['Response']['address'].toString();
          userwallet = json.decode(response.body)['Response']['user_wallet'].toString();
          cashback = (parse(parse(json.decode(response.body)['Response']['pay_now_bonus'].toString()).body.text).documentElement.text).toString();
